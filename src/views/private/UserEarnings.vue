  ...
  <div class="w-full bg-slate-100">
    ...
    <div class="w-full pt-5 pb-10 px-5">
      <div class="w-full bg-white flex flex-col md:flex-row">
        ...
        <UserEarningHistory :key="depHisKey" />
      </div>
    </div>
...
import PaymentsPage from "../../components/Earnings/PaymentsPage.vue";
import UserEarningHistory from "../../components/Earnings/UserEarningHistory.vue";
